...
import uk.ac.belfast.titanic.service.PassengerRestService;

@RestController
@RequestMapping("/api/passenger")
public class PassengerRestControl {
       ...
       public PassengerRestControl(PassengerRestService passengerRestService) {
		super();
